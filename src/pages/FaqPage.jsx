...
const FAQS = [
    ...
    { q: 'How much does a 3D render cost?', a: 'Indicative starting points: ₹15,000–₹40,000 per view in India, $250–$600 internationally. Final quote depends on complexity, turnaround and volume — get in touch for a custom quote.' },
    ...
    { q: 'What software do you use?', a: 'SketchUp and AutoCAD for modelling, Lumion for photoreal rendering, and Adobe Photoshop for post-production.' },
    ...
    { q: 'Where are you based?', a: 'We have offices in Amritsar, Delhi and Chandigarh. We serve clients globally — remote-first by default, with walk-in consultations available at all three locations.' },
];
